...
using RabbitMQMultipleConsumers.Models;
using RabbitMQMultipleConsumers.RabbitMQ;
using RabbitMQMultipleConsumers.Services;

namespace RabbitMQMultipleConsumers.Controllers
{
